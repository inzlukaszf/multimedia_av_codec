...
#ifndef AVCODEC_AUDIO_AVBUFFER_LBVC_ENCODER_INNER_DEMO_H
#define AVCODEC_AUDIO_AVBUFFER_LBVC_ENCODER_INNER_DEMO_H
...
namespace InnerAudioEncoderLbvcDemo {

class AudioEncInnerAvBufferLbvcDemo {
public:
    AudioEncInnerAvBufferLbvcDemo() = default;
    virtual ~AudioEncInnerAvBufferLbvcDemo() = default;
    void RunCase();
    void InputFunc();
    void OutputFunc();
...
public:
    explicit AudioCodecConsumerListener(AudioEncInnerAvBufferLbvcDemo *demo);

    void OnBufferAvailable() override;

private:
    AudioEncInnerAvBufferLbvcDemo *demo_;
};

} // namespace InnerAudioDemo
} // namespace MediaAVCodec
} // namespace OHOS
#endif // AVCODEC_AUDIO_AVBUFFER_LBVC_ENCODER_INNER_DEMO_H
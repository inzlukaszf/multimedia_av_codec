...
namespace {
constexpr std::string_view INPUT_FILE_PATH = "/data/test/media/lbvc_1c_16000hz_6k.dat";
constexpr std::string_view OUTPUT_PCM_FILE_PATH = "/data/test/media/lbvc_1c_16000hz_6k_test.pcm";
...
AudioCodecConsumerListener::AudioCodecConsumerListener(AudioDecInnerAvBufferLbvcDemo *demo)
{
    demo_ = demo;
}
...
void AudioDecInnerAvBufferLbvcDemo::RunCase()
{
    innerBufferQueue_ = Media::AVBufferQueue::Create(4, Media::MemoryType::SHARED_MEMORY, "InnerDemo");  // 4

    audiocodec_ = AudioCodecFactory::CreateByName("OH.Media.Codec.Decoder.Audio.LBVC");
...
int32_t AudioDecInnerAvBufferLbvcDemo::GetInputBufferSize()
{
    int32_t capacity = 0;
...
void AudioDecInnerAvBufferLbvcDemo::InputFunc()
{
...
void AudioDecInnerAvBufferLbvcDemo::OutputFunc()
{

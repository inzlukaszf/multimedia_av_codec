...
#ifndef AVSOURCE_INNER_MOCK_H
#define AVSOURCE_INNER_MOCK_H
...
class AVSourceInnerMock : public AVSourceMock {
public:
    explicit AVSourceInnerMock(std::shared_ptr<AVSource> source) : source_(source) {}
    ~AVSourceInnerMock() = default;

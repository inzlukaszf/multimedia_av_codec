 ...
 */
#ifndef AUDIO_LBVC_DECODER_PLUGIN_H
#define AUDIO_LBVC_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Lbvc {
class AudioLbvcDecoderPlugin : public CodecPlugin {
public:
    explicit AudioLbvcDecoderPlugin(const std::string &name);

    ~AudioLbvcDecoderPlugin();

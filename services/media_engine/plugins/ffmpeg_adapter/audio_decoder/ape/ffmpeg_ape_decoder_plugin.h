...
#ifndef FFMPEG_APE_DECODER_PLUGIN_H
#define FFMPEG_APE_DECODER_PLUGIN_H
...
namespace Plugins {
namespace Ffmpeg {
class FFmpegAPEDecoderPlugin : public CodecPlugin {
public:
    explicit FFmpegAPEDecoderPlugin(const std::string& name);

    ~FFmpegAPEDecoderPlugin();

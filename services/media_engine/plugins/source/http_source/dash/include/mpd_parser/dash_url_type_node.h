...
#ifndef DASH_URL_TYPE_NODE_H
#define DASH_URL_TYPE_NODE_H
...
class DashUrlTypeNode : public IDashMpdNode {
public:
    DashUrlTypeNode();
    ~DashUrlTypeNode() override;
...
private:
    static constexpr int32_t DASH_URL_TYPE_ATTR_NUM = 2;
    static constexpr const char *urlTypeAttrs_[DASH_URL_TYPE_ATTR_NUM] = {"sourceURL", "range"};

    NodeAttr urlTypeAttr_[DASH_URL_TYPE_ATTR_NUM];
};
} // namespace HttpPluginLite
} // namespace Plugin
} // namespace Media
} // namespace OHOS
#endif // DASH_URL_TYPE_NODE_H

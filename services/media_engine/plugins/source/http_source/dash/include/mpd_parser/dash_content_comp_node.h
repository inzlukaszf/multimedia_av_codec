...
#ifndef DASH_CONTENT_COMPONENT_NODE_H
#define DASH_CONTENT_COMPONENT_NODE_H
...
class DashContentCompNode : public IDashMpdNode {
public:
    DashContentCompNode();
    ~DashContentCompNode() override;
...
private:
    static constexpr int32_t DASH_CONTENT_COMP_ATTR_NUM = 4;
    static constexpr const char *contentCompAttrs_[DASH_CONTENT_COMP_ATTR_NUM] = {"id", "lang", "contentType", "par"};

    NodeAttr contentCompAttr_[DASH_CONTENT_COMP_ATTR_NUM];
};
} // namespace HttpPluginLite
} // namespace Plugin
} // namespace Media
} // namespace OHOS
#endif // DASH_CONTENT_COMPONENT_NODE_H

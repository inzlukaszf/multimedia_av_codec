...
#ifndef DASH_SEG_TEMPLATE_NODE_H
#define DASH_SEG_TEMPLATE_NODE_H
...
class DashSegTemplateNode : public IDashMpdNode {
public:
    DashSegTemplateNode();
    ~DashSegTemplateNode() override;
...
private:
    static constexpr int32_t DASH_SEG_TEMPLATE_ATTR_NUM = 4;
    static constexpr const char *segTemplateAttrs_[DASH_SEG_TEMPLATE_ATTR_NUM] = {"media", "index", "initialization",
                                                                                  "bitstreamSwitching"};

    NodeAttr segTemplateAttr_[DASH_SEG_TEMPLATE_ATTR_NUM];
...
#endif // DASH_SEG_TEMPLATE_NODE_H

...
#ifndef DASH_SEGMENT_TIMELINE_NODE_H
#define DASH_SEGMENT_TIMELINE_NODE_H
...
class DashSegTmlineNode : public IDashMpdNode {
public:
    DashSegTmlineNode();
...
private:
    static constexpr int32_t DASH_SEG_TIMELINE_ATTR_NUM = 3;
    static constexpr const char *segTmlineAttrs_[DASH_SEG_TIMELINE_ATTR_NUM] = {"t", "d", "r"};
    NodeAttr segTmlineAttr_[DASH_SEG_TIMELINE_ATTR_NUM];
};
} // namespace HttpPluginLite
} // namespace Plugin
} // namespace Media
} // namespace OHOS
#endif // DASH_SEGMENT_TIMELINE_NODE_H

...
#ifndef DASH_SEGMENT_BASE_NODE_H
#define DASH_SEGMENT_BASE_NODE_H
...
class DashSegBaseNode : public IDashMpdNode {
public:
    DashSegBaseNode();
    ~DashSegBaseNode() override;
...
private:
    static constexpr int32_t DASH_SEG_BASE_ATTR_NUM = 4;
    static constexpr const char *segBaseAttrs_[DASH_SEG_BASE_ATTR_NUM] = {"timescale", "presentationTimeOffset",
                                                                          "indexRange", "indexRangeExact"};
    NodeAttr segBaseAttr_[DASH_SEG_BASE_ATTR_NUM];
};
} // namespace HttpPluginLite
} // namespace Plugin
} // namespace Media
} // namespace OHOS
#endif // DASH_SEGMENT_BASE_NODE_H

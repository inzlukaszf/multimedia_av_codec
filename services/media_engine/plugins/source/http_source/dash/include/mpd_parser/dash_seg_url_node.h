...
#ifndef DASH_SEG_URL_NODE_H
#define DASH_SEG_URL_NODE_H
...
class DashSegUrlNode : public IDashMpdNode {
public:
    DashSegUrlNode();
    ~DashSegUrlNode() override;
...
private:
    static constexpr int32_t DASH_SEG_URL_ATTR_NUM = 4;
    static constexpr const char *segUrlAttrs_[DASH_SEG_URL_ATTR_NUM] = {"media", "mediaRange", "index", "indexRange"};

    NodeAttr segUrlAttr_[DASH_SEG_URL_ATTR_NUM];
};
} // namespace HttpPluginLite
} // namespace Plugin
} // namespace Media
} // namespace OHOS
#endif // DASH_SEG_URL_NODE_H

...
#ifndef DASH_PERIOD_NODE_H
#define DASH_PERIOD_NODE_H
...
class DashPeriodNode : public IDashMpdNode {
public:
    DashPeriodNode();
    ~DashPeriodNode() override;
...
private:
    static constexpr int32_t DASH_PERIOD_ATTR_NUM = 4;
    static constexpr const char *periodAttrs_[DASH_PERIOD_ATTR_NUM] = {"id", "start", "duration",
                                                                       "bitstreamSwitching"};

    NodeAttr periodAttr_[DASH_PERIOD_ATTR_NUM];
};
} // namespace HttpPluginLite
} // namespace Plugin
} // namespace Media
} // namespace OHOS
#endif // DASH_PERIOD_NODE_H

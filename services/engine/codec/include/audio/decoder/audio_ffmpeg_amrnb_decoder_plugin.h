...
#ifndef AUDIO_FFMPEG_AMRNB_DECODER_PLUGIN_H
#define AUDIO_FFMPEG_AMRNB_DECODER_PLUGIN_H
...
class AudioFFMpegAmrnbDecoderPlugin : public AudioBaseCodec::CodecRegister<AudioFFMpegAmrnbDecoderPlugin> {
public:
    AudioFFMpegAmrnbDecoderPlugin();
    ~AudioFFMpegAmrnbDecoderPlugin() override;
    ...
    {
        return std::string(AVCodecCodecName::AUDIO_DECODER_AMRNB_NAME);
    }
